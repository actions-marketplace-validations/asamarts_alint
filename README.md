...
- **Official GitHub Action**: [`asamarts/alint@v0.14.1`](https://github.com/asamarts/alint).
...
docker run --rm -v "$PWD:/repo" ghcr.io/asamarts/alint:v0.14.1 check
```
...
Also published: `:<major>.<minor>` (e.g. `:0.13`) and the raw git tag (`:v0.14.1`).
...
- uses: asamarts/alint@v0.14.1
  with:
    version: v0.14.1        # alint release tag (default: latest)
