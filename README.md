...
- **Official GitHub Action**: [`asamarts/alint@v0.14.2`](https://github.com/asamarts/alint).
...
Also published: `:<major>.<minor>` (e.g. `:0.13`) and the raw git tag (`:v0.14.2`).
...
- uses: asamarts/alint@v0.14.2
  with:
    version: v0.14.2        # alint release tag (default: latest)
