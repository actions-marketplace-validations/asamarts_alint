...
- **Official GitHub Action**: [`asamarts/alint@v0.11.0`](https://github.com/asamarts/alint).
...
Also published: `:<major>.<minor>` (e.g. `:0.10`) and the raw git tag (`:v0.11.0`).
...
- uses: asamarts/alint@v0.11.0
  with:
    version: v0.11.0        # alint release tag (default: latest)
