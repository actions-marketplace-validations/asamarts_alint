...
- **Official GitHub Action**: [`asamarts/alint@v0.10.0`](https://github.com/asamarts/alint).
...
docker run --rm -v "$PWD:/repo" ghcr.io/asamarts/alint:v0.10.0 check
```
...
- uses: asamarts/alint@v0.10.0
  with:
    version: v0.10.0        # alint release tag (default: latest)
