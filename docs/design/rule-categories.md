...
**Categories:** Encoding, Security / Unicode sanity
...
`crates/alint-rules/src/categories.gen.rs`, of the form:

```rust
// @generated by `cargo run -p xtask -- gen-categories`. Do not edit.
pub static KIND_CATEGORIES: &[(&str, &[Category])] = &[
    ("no_bidi_controls", &[Category::Encoding, Category::SecurityUnicodeSanity]),
    // ...
];
...
"rule_categories": {
  "no_bidi_controls": ["encoding", "security-unicode-sanity"],
  "file_hash": ["portable-metadata", "security-unicode-sanity"]
}
```
