...
Contact: mailto:asamarts@alint.org
...
| Field | Value | Why |
|---|---|---|
| `Contact` (email) | `asamarts@alint.org` | Matches the SECURITY.md primary contact. RFC 9116 allows multiple `Contact:` lines; email is the lowest-friction default. |
